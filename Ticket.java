...
public class Ticket {
	...
	public void createPdf() {
		...
		try {
			...
			PdfWriter.getInstance(document, new FileOutputStream("Boarding_Pass.pdf"));
			document.open();
			...
			Chunk c2 = new Chunk("\nDelta Flight #" + planeNumber, font2);
			...
			Chunk c6 = new Chunk("Arrival Time: " + arrivalTime, f4);
			//c6.setBackground(BaseColor.LIGHT_GRAY);
	...
	public static void main(String args[]) throws IOException {
		...
		user.setEmail("bethenoah69@gmail.com");
		user.setFirstName("Noah");
		user.setLastName("Lone");

		// Flight setters for Ticket information
		Flight f = new Flight();
		f.setToAirCode("ATL");
		f.setFromAirCode("BOS");
		f.setPlaneNumber(43123473);
		f.setBoardingTime("10:22 AM");
		f.setDepartTime("11:00 AM");
		f.setArrivalTime("3:43 PM");
		f.setGate("F 13");
		f.setDepartDate("7/22/2018");
		f.setArrivalDate("7/23/2018");
		f.setArrivalDate("10/2/2018");
